...
class _RelatorioTitulosScreenState extends State<RelatorioTitulosScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(future: relatorioProvider.futureRelatorio, builder: (context, snapshot) => Padding(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(child: _CardSaldo(valor: relatorioProvider.saldoAVencer())),
                  SizedBox(
                    width: 8.w,
                  ),
                  Expanded(
            ...
            Expanded(
              child: Padding(
                ...
                child: SingleChildScrollView(
                    child: Column(
                      children: relatorioProvider.titulos.listaTitulos.map((item) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  ...
                                  child: Text(
                                    ...
                                    style: context.textTheme.bodyMedium!.copyWith(color: context.labelTextColor),
                                  ),
                                ),
                                SizedBox(
                                  width: 8.w,
                                ...
                                Expanded(
                                  flex: 3,
                                  child: Text(UtilBrasilFields.obterReal(item.valor), style: context.textTheme.bodyMedium!.copyWith(color: context.labelTextColor),),
                                ),
                                SizedBox(width: 5.w,),
                                Expanded(
                                  flex: 4,
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: context.textTheme.bodyMedium!
                                                .copyWith(
                                                color: item.status.corTexto, fontWeight: FontWeight.w100),
                                          ),
                                        ),
                                      ),
                                      IconButton(icon: Icon(Icons.download, color: context.labelTextColor,), onPressed: (){},),
                                    ],
                                  ),
                                ),
                              ],
            ...
            Center(
              child: SizedBox(
                ...
                child: Padding(
                  ...
                  child: BotaoPadrao(label: 'Salvar PDF', onPressed: (){}),
                ),
              ),
            )
          ],
