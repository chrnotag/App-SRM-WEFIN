...
import 'package:flutter_mobile_project/app/core/rest_client/dio/auth_interceptor.dart';
import 'package:flutter_mobile_project/app/core/rest_client/dio/auth_refresh_token_interceptor.dart';
...
import 'package:flutter_mobile_project/app/core/rest_client/rest_client_response.dart';
...
class DioRestClient extends RestClient {
  ...
  final _defaultOptions = BaseOptions(
    ...
    connectTimeout: int.parse(
        Environments.param(Constants.ENV_REST_CLIENT_CONNECT_TIMOEOUT_KEY) ??
            '0'),
    receiveTimeout: int.parse(
        Environments.param(Constants.ENV_REST_CLIENT_RECEIVE_TIMOEOUT_KEY) ??
            '0'),
  );
